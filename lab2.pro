...
clauses
    ...
    run() :-
        общий_счёт('Галацан Николай Ильич'),
        fail.

    run() :-
        назначенное_лечение('Галацан Николай Ильич'),
        fail.

    run() :-
        назначенные_препараты('Галацан Николай Ильич'),
        fail.
    run() :-
        история_болезней('Галацан Николай Ильич'),
        fail.
